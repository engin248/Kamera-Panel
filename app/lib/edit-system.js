    ...
    business_expenses: [
        {
            key: 'category', label: 'Kategori', type: 'select', options: [
                ...
                { value: 'su', label: '💧 Su' },
                { value: 'internet_telefon', label: '📡 İnternet / Telefon' },
                { value: 'sigorta', label: '🛡️ Sigorta' },
                { value: 'iplik', label: '🧵 İplik / Malzeme' },
                { value: 'makine_bakim', label: '🔧 Makine Tamiri / Bakım' },
                { value: 'yedek_parca', label: '⚙️ Yedek Parça' },
                { value: 'araba_benzin', label: '⛽ Araba Benzin' },
                { value: 'araba_bakim', label: '🚗 Araba Bakım' },
                { value: 'muhasebe', label: '🧾 Muhasebe' },
                { value: 'kdv', label: '📋 KDV' },
                { value: 'stopaj', label: '📄 Stopaj' },
                { value: 'vergi', label: '🏛️ Vergi' },
                { value: 'personel_maas', label: '💰 Personel Maaşı' },
                { value: 'personel_yemek', label: '🍽️ Personel Yemeği' },
                { value: 'personel_yol', label: '🚌 Personel Yol Parası' },
                { value: 'personel_mesai', label: '⏰ Fazla Mesai Ücreti' },
                { value: 'temizlik', label: '🧹 Temizlik Malzemesi' },
                { value: 'mutfak', label: '☕ Mutfak (Çay/Şeker/İçecek)' },
                { value: 'diger', label: '📦 Diğer' },
            ]
        },
        { key: 'amount', label: 'Tutar (₺)', type: 'number' },
        { key: 'description', label: 'Açıklama' },
        { key: 'is_recurring', label: 'Her Ay Tekrarlayan', type: 'checkbox' },
    ],
    cost_entries: [
        { key: 'category', label: 'Kategori' },
        { key: 'description', label: 'Açıklama' },
        { key: 'amount', label: 'Birim Tutar', type: 'number' },
